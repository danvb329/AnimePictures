...
-(NSSet*)fields{
	return [NSSet setWithObjects:@"first_name", @"last_name", @"sex", nil];
}

-(NSSet*)optional{
	return [NSSet setWithObjects:@"photo",nil];
}
...
-(NSURL*)apiURL:(id<ULProvider>)provider{
	...
	url = [url stringByAppendingString:@"&window=0&lang=ru&client=undefined&fields="];
